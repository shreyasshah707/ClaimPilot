...
export const mockClaims: Claim[] = [
  ...
  },
  {
    ...
    policyNumber: 'POL-M-334455',
    vehicle: 'Kia Seltos',
    claimType: 'Accident',
    incidentDate: '2026-08-16',
    location: 'Chennai, Tamil Nadu',
    description: 'Claimed pre-existing damages on rear quarter panel not matching incident description.',
    submittedAt: new Date(Date.now() - 36 * 3600000).toISOString(),
    status: 'Rejected',
    rejectionReason: 'Damage patterns inconsistent with reported incident description and telematics speed data.',
    reviewedByAgent: true,
  ...
  },
  {
    ...
    policyNumber: 'POL-M-778899',
    vehicle: 'Volkswagen Taigun',
    claimType: 'Accident',
    incidentDate: '2026-08-17',
    location: 'Hyderabad, Telangana',
    description: 'Side mirror collision during lane change.',
    submittedAt: new Date(Date.now() - 48 * 3600000).toISOString(),
    status: 'Under Review',
    requestInfoReason: 'Please upload a clearer high-resolution photo of the side mirror housing and the FIR/incident GD entry.',
    reviewedByAgent: true,
    agentAction: 'More Info Requested',
    images: ['https://images.unsplash.com/photo-1563223771-5f8f8b6f3a38?auto=format&fit=crop&q=80&w=800'],
    fraudRisk: 'Low'
  }
];
